...
<SlideOverPanel {isOpen} title="{payGroup.name} Employees" width="md" onClose={handleClose}>
	...
	{#if isLoading}
		<div class="flex flex-col items-center justify-center py-12">
			<div
				class="w-10 h-10 border-4 border-surface-200 border-t-primary-500 rounded-full animate-spin mb-4"
			></div>
		...
		<div class="mb-6">
			...
			{#if assignedEmployees.length === 0}
				<div class="flex flex-col items-center py-8 px-4 bg-surface-50 rounded-lg text-center">
					<div
						class="w-14 h-14 rounded-full bg-surface-200 text-surface-400 flex items-center justify-center text-xl mb-3"
					>
